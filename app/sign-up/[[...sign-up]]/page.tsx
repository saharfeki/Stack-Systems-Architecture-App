            ...
            <div className="space-y-6">
              <div>
                ...
                <h1 className="mt-3 text-3xl font-semibold text-copy-primary">
                  Start building shared architecture from a quick idea.
                </h1>
              </div>

              <ul className="space-y-3 text-sm text-copy-secondary">
                <li>• Create architecture projects in minutes</li>
                <li>• Collaborate on live design changes</li>
                <li>• Turn the final graph into a technical spec</li>
              </ul>
            </div>
          </section>
